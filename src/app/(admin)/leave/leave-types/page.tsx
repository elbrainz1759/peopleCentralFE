            ...
            <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white px-4 pb-3 pt-4 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6">
                ...
                <div className="block md:hidden min-h-[400px]">
                    {isLoading ? (
                        ...
                        <p className="py-10 text-center text-gray-500">No leave types found.</p>
                    ) : (
                        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                            {filtered.map((lt) => (
                                <div key={lt.id} className="rounded-xl border border-gray-100 bg-gray-50 p-4 dark:border-gray-800 dark:bg-white/[0.03]">
                                    ...
                                    {lt.description && <p className="text-xs text-gray-500 dark:text-gray-400 line-clamp-2 mb-2">{lt.description}</p>}
                                    <div className="space-y-1 text-xs text-gray-500 dark:text-gray-400 mb-3">
                                        ...
                                        <div className="flex justify-between">
                                            <span className="font-medium text-gray-600 dark:text-gray-300">Date Added</span>
                                            <span>{lt.created_at ? new Date(lt.created_at).toLocaleDateString() : "—"}</span>
                                        </div>
                                    </div>
                                    <div className="flex gap-2">
                                        <button onClick={() => openEdit(lt)} className="flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-lg border border-gray-200 text-xs font-medium text-gray-600 hover:bg-gray-100 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-800">
